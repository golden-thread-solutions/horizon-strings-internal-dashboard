...
On 24 September 2026 the owner confirmed a fixed $400 deposit and requested spreadsheet-equivalent calculations. Ceremony playing start, arrival and remaining playing time are calculated from their source inputs. Total fee, received, outstanding, final invoice and estimated profit remain calculated. Performance fee remains an editable quoted amount, with common-value suggestions, rather than recreating the spreadsheet's internal hourly-rate estimate.
